                        ...
                        <div class="col-md-7 pe-0">
                            <div class="form-left h-100 py-5 px-5">
                                ...
                                <form action="controller" method="post" class="row g-4">
                                    ...
                                    <div class="col-12">
                                        <label>Nombre<span c,lass="float-end text-primary">&nbsp; (*)</span></label>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="tipo" class="form-select" id="validationCustom04" required="">
                                            <option class="form-control" selected disabled value="">Tipo de Privilegios</option>
                                    ...
                                    <input type="hidden" value=44 name="opcion" >
